export const API_URLS = {
  ...
  ADMIN: {
    BASE: '/api/admin',
    LOGIN: `/login`,
    GET_POST_STATISTICS:(period: number)=>`/posts/statistics?period=${period}`,
    GET_TRIP_STATISTICS:(period: number)=>`/trips/statistics?period=${period}`,
    GET_USER_STATISTICS:(period: number)=>`/users/statistics?period=${period}`,
